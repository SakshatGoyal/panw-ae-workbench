...
// Source: svg/ai-general-03.svg
import * as React from 'react';
import type { IconProps } from '../../types';

export const AiGeneral03 = React.forwardRef<SVGSVGElement, IconProps>(
  function AiGeneral03({ size = 24, className, title, 'aria-label': ariaLabel, ...rest }, ref) {
    return (
      <svg
        ref={ref}
        width={size}
