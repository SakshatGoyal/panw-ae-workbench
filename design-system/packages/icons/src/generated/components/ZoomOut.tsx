...
export const ZoomOut = React.forwardRef<SVGSVGElement, IconProps>(
  function ZoomOut({ size = 20, className, title, 'aria-label': ariaLabel, ...rest }, ref) {
    return (
      <svg
        ref={ref}
        width={size}
