...
// Source: svg/plus-square.svg
import * as React from 'react';
import type { IconProps } from '../../types';

export const PlusSquare = React.forwardRef<SVGSVGElement, IconProps>(
  function PlusSquare({ size = 20, className, title, 'aria-label': ariaLabel, ...rest }, ref) {
    return (
      <svg
        ref={ref}
        width={size}
