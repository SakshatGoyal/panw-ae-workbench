...
describe('TextEntry', () => {
  it('renders with title and placeholder', () => {
    render(<TextEntry title="T" placeholder="P" />);
  ...
  it('forwards ref to the input', () => {
    ...
    render(<TextEntry ref={ref} title="x" />);
